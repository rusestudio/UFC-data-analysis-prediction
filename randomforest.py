...
X_train, X_valid, y_train, y_valid = train_test_split(
    X_train_valid, y_train_valid, test_size=0.25, random_state=1, stratify=y_train_valid
)
...
union_df = imp_df[
    imp_df["feature"].isin(union_vars) & ~imp_df["feature"].isin(remove_vars)
]
...
valid_proba = cross_val_predict(
    rf_final, X_train, y_train, cv=cv, method="predict_proba"
)
